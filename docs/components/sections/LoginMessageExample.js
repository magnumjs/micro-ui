import { createComponent, useState } from "https://unpkg.com/@magnumjs/micro-ui/dist/magnumjs-micro-ui.all.esm.js";
...
export const LoginMessageExampleSection = createComponent(() => {
  ...
  const explanations = [
    ...
    '<b>useState</b>: MicroUI hook for local state. <code>useState(\'\')</code> creates a reactive value and setter.',
