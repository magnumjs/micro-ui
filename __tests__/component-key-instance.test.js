...
//   expect(childInstA.toString()).toBe("<span>A:red</span>");
//   expect(childInstB.toString()).toBe("<span>B:green</span>");
  expect(childInstC.toString()).toBe("<span>C:blue</span>");
...
//   expect(htmlKeysBeforeMount.toString()).toContain("<span>B:green</span>");
  expect(htmlKeysBeforeMount.toString()).toContain("<span>C:blue</span>");
...
//   expect(htmlNoKeys.toString()).toContain("<span>B:green</span>");
  expect(htmlNoKeys.toString()).toContain("<span>C:blue</span>");
...
//   expect(htmlKeysAfterMount.toString()).toContain("<span>B:green</span>");
  expect(htmlKeysAfterMount.toString()).toContain("<span>C:blue</span>");
  });
});
